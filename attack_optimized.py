"""ARCHIVED Optimized EXFIL farm (scored ~55–56 on Kaggle).

Kept for A/B reference only. Default submission is hardened Single-Farm in
``attack.py`` (scored ~61 as Single-Farm; plus safe volume hardenings).

Do not submit this file unless deliberately A/B testing against the default.
